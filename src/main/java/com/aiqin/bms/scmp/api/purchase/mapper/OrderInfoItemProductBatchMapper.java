...
public interface OrderInfoItemProductBatchMapper {
    ...
    Integer selectBatchList(@Param("skuCode") String skuCode, @Param("orderCode") String orderCode, @Param("batchCode") String batchCode, @Param("lineCode") Long lineCode);

    Integer updateBatch(List<OrderInfoItemProductBatch> batchList);

    Integer updateByReturnBatchCount(OrderInfoItemProductBatch record);
}