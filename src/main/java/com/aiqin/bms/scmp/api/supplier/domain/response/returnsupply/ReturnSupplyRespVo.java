...
import com.aiqin.bms.scmp.api.base.ReturnSupplyStatus;
...
@Data
@ApiModel("退供单返回vo")
public class ReturnSupplyRespVo {
    ...
    private String returnSupplyStatus;

    public void setReturnSupplyStatus(Byte returnSupplyStatus) {
        this.returnSupplyStatus = ReturnSupplyStatus.getAllStatus().get(returnSupplyStatus).getDesc();
    }
