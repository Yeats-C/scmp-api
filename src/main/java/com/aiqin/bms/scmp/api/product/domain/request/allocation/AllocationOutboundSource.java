...
@Data
public class AllocationOutboundSource implements Serializable {
    ...
    @ApiModelProperty(value="调拨入库")
    @JsonProperty("callin_warehouse_code")
    private String callinWarehouseCode;

    @ApiModelProperty(value="来源类型  02")
