...
public interface ProductSkuConfigService {
     ...
     * @param userName
     */
    void workFlow(String formNo, String applyCode, String userName,String directSupervisorCode,String approvalName,String approvalRemark, String positionCode);
