...
public interface PurchaseApplyService {
    ...
    HttpResponse<List<PurchaseApplyDetailResponse>> searchApplyProduct(String applyProductId);
    ...
    HttpResponse purchaseApplyStatus(String purchaseApplyId, Integer applyStatus);
