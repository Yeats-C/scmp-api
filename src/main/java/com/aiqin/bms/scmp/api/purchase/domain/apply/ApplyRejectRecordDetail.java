package com.aiqin.bms.scmp.api.purchase.domain.apply;
...
@ApiModel
public class ApplyRejectRecordDetail {
    ...
    public String getRejectRecordDetailId() {
        return rejectRecordDetailId;
    }

    public void setRejectRecordDetailId(String rejectRecordDetailId) {
        this.rejectRecordDetailId = rejectRecordDetailId;
    }
    ...
    public String getFactorySkuCode() {
        return factorySkuCode;
    }

    public void setFactorySkuCode(String factorySkuCode) {
        this.factorySkuCode = factorySkuCode;
    }
