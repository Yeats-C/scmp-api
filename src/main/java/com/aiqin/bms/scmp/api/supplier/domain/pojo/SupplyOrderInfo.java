...
public class SupplyOrderInfo {
    ...
    public Byte getBeException() {
        return beException;
    }

    public void setBeException(Byte beException) {
    ...
    public Long getBeDelete() {
        return beDelete;
    }

    public void setBeDelete(Long beDelete) {
    ...
    public Byte getBeFather() {
        return beFather;
    }

    public void setBeFather(Byte beFather) {
        this.beFather = beFather;
    }

    public String getFatherOrderCode() {
        return fatherOrderCode;
    }

    public void setFatherOrderCode(String fatherOrderCode) {
        this.fatherOrderCode = fatherOrderCode == null ? null : fatherOrderCode.trim();
    }
    ...
    public void setOrderOriginal(String orderOriginal) {
        this.orderOriginal = orderOriginal == null ? null : orderOriginal.trim();
    }
