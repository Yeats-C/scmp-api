...
//			if (rfcNameObj == null){
//				throw  new FServiceException(SapUtil.class.getName()+" init exception , by conf [sap.rfcName] value is required，You can specify this through the configuration file ！");
//			}
//			rfcName  = rfcNameObj.toString();
//			if (ValidateUtil.isNull(sapPoolName)){
...
//					</bean>
//				*/
//				throw  new FServiceException(SapUtil.class.getName()+" init exception , by prop [sapPoolName] value is required，You can specify this through the configuration file ！");
//			}
...
//	 * @return
//	 */
//	public  String createSend(String rfcName,String methodCode,String data) throws  FServiceException{
//		//获取传输对象 JCoFunction
...
//			}
//		}
//		throw  new FServiceException("获取 rfc 传输对象 失败");
//	}
//
//	/**
//	 * 填充数据,根据上面表格
