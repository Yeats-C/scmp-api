...
//                    warehouseBatchNumber.add(o.getWarehouseBatchNumber());
    ...
    public PriceMeasurementRespVO priceMeasurement(List<PriceMeasurementReqVO> req) {
        ...
        long deAmount = stream1.mapToLong(o -> Optional.ofNullable(collect.get(o.getSkuCode()).getSaleNum()).orElse(0) * Optional.ofNullable(o.getNewGrossProfitMargin()).orElse(0L) * Optional.ofNullable(o.getPrice()).orElse(0L)).sum();
        long inAmount = stream1.mapToLong(o -> Optional.ofNullable(collect.get(o.getSkuCode()).getSaleNum()).orElse(0) * Optional.ofNullable(o.getNewGrossProfitMargin()).orElse(0L) * Optional.ofNullable(o.getPrice()).orElse(0L)).sum();
