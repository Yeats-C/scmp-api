...
//    private String qualityNumber;
    ...
    @ExcelProperty(index = 23, value = "季节")
    ...
    @ExcelProperty(index = 28, value = "商品介绍")
    private String productDesc;

    @ApiModelProperty("厂家指导价")
    @ExcelProperty(index = 29, value = "厂家指导价")
    private String manufacturerGuidePrice;

    @ApiModelProperty("规格")
    @ExcelProperty(index = 30, value = "库存规格")
    private String stockSpec;

    @ApiModelProperty("单位名称")
    @ExcelProperty(index = 31, value = "库存单位")
    private String stockUnitName;

    @ApiModelProperty("包装箱子长度")
    @ExcelProperty(index = 32, value = "库存长")
    private String stockBoxLength;

    @ApiModelProperty("宽度（mm）")
    @ExcelProperty(index = 33, value = "库存宽")
    private String stockBoxWidth;

    @ApiModelProperty("箱子高度")
    @ExcelProperty(index = 34, value = "库存高")
