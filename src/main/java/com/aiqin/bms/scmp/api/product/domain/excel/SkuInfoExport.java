...
public class SkuInfoExport extends BaseRowModel {
    ...
    @ExcelProperty(index = 5, value = "所属部门")
    ...
    @ExcelProperty(index = 6, value = "品类名称")
    private String productCategoryName;

    @ApiModelProperty("商品品类编码")
    @ExcelProperty(index = 6, value = "品类编码")
    ...
    @ExcelProperty(index = 7, value = "采购组")
    ...
    @ExcelProperty(index = 20, value = "使用时长(天)")
    ...
    @ExcelProperty(index = 25, value = "商品介绍")
    ...
    @ExcelProperty(index = 41, value = "采购单位含量")
    ...
    @ApiModelProperty("拆零系数")
    @ExcelProperty(index = 47, value = "分销交易倍数")
...
//    private String saleZeroRemovalCoefficient;
    ...
    @ExcelProperty(index = 59, value = "供应商编码")
    private String supplyUnitCode;

    @ApiModelProperty("供货单位名称")
    @ExcelProperty(index = 59, value = "供应商名称")
    private String supplyUnitName;

    // @ApiModelProperty("含税采购价")
    // @ExcelProperty(index = 60, value = "含税采购价")
    ...
    @ExcelProperty(index = 71, value = "售价")
    private String readyCol73;

    @ApiModelProperty(value ="会员价")
    @ExcelProperty(index = 71, value = "会员价")
