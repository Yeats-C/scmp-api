...
//                        }
                ...
                //sku质检信息
                if(!flag && CollectionUtils.isNotEmpty(addSkuInfoReqVO.getProductSkuInspReportDrafts())) {
            ...
            //sku文件管理
            if (!flag && null != addSkuInfoReqVO.getProductSkuFileDrafts() && addSkuInfoReqVO.getProductSkuFileDrafts().size() > 0){
