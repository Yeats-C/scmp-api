...
public class SkuSaleVolumeServiceImpl implements SkuSaleVolumeService {
    ...
    public HttpResponse saveBatch(List<SkuSaleVolumeVo> skuSaleVolumes) throws BizException{
        try {
            ...
            if(e instanceof BizException){
                ...
                throw new BizException(ResultCode.SAVE_BATCH_SKU_SALE_VOLIME_ERROR);
            }
        }
    }
