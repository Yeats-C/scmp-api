...
import com.aiqin.bms.scmp.api.product.domain.request.returnsupply.ReturnSupplyItemReqVo;
...
/**
 * @author knight.xie
 * @className VerifyReturnSupplyReqVo
 * @date 2019/1/4 16:12
 * @description 验证库存商品sku请求VO(退供使用)
 * @version 1.0
 */
@Data
@ApiModel("验证库存商品sku请求VO")
public class VerifyReturnSupplyReqVo implements ILockStockReqVO {
