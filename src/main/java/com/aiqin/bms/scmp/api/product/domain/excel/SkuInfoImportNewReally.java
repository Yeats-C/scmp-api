...
public class SkuInfoImportNewReally extends BaseRowModel {
    ...
    @ExcelProperty(index = 45, value = "厂商SKU编码")
    ...
    @ExcelProperty(index = 63, value = "采购基商品含量")
    ...
    @ExcelProperty(index = 65, value = "分销拆零系数")
