...
public class SkuInfoImportNew extends BaseRowModel {
    ...
    @ExcelProperty(index = 27, value = "覆盖渠道")
    private String priceChannelName;

    @ApiModelProperty("标签名称")
    @ExcelProperty(index = 28, value = "商品标签")
    private String tagName;

    @ApiModelProperty("备注")
    @ExcelProperty(index = 29, value = "商品备注")
    private String remark;

    @ApiModelProperty("商品介绍")
    @ExcelProperty(index = 30, value = "商品介绍")
    private String productDesc;

    @ApiModelProperty("厂商指导价")
    @ExcelProperty(index = 31, value = "厂商指导价")
    private String manufacturerGuidePrice;

    @ApiModelProperty("含税采购价")
    @ExcelProperty(index = 32, value = "含税采购价")
